...
import java.util.Properties;
 ...
 public class DBConnection {
	 ...
	 ***************************************************************************************/
	private DBConnection() throws BankException {
		try {
	...
	public static DBConnection getInstance() throws BankException {
	...
	public Connection getConnection() throws BankException {
		try {
			...
			throw new BankException(" Database connection problem");
		}
		return conn;
	}
